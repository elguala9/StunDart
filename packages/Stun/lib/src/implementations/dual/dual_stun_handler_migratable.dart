...
import 'package:stun/src/implementations/dual/dual_stun_handler.dart';
...
class DualStunHandlerMigratable extends DualStunHandler
  ...
  factory DualStunHandlerMigratable.dependencyInjectionFactory({String key = 'default', String subkey = 'default'}) { // GENERATED CODE - DO NOT MODIFY BY HAND
    final ipv4Handler = RegistryManager.instance.tryGetInstance<IStunHandlerMigratable>(key: key, subkey: 'ipv4'); // GENERATED CODE - DO NOT MODIFY BY HAND
    final ipv6Handler = RegistryManager.instance.tryGetInstance<IStunHandlerMigratable>(key: key, subkey: 'ipv6'); // GENERATED CODE - DO NOT MODIFY BY HAND
